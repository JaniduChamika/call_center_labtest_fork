        ...
        <div className="max-w-5xl mx-auto w-full p-6 md:p-8 pb-20">
            ...
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
              <div className="flex flex-col md:flex-row gap-4 mb-8">
                <div className="flex-1 bg-white border border-slate-200 rounded-xl flex items-center px-4 py-1 shadow-sm focus-within:ring-2 focus-within:ring-blue-100 transition-all">
                  ...
                  <input
                    className="w-full py-3 outline-none bg-transparent text-sm font-medium"
                ...
                <select
                  className="border border-slate-200 rounded-xl px-4 py-3 bg-white text-sm font-bold text-slate-600 outline-none cursor-pointer hover:border-blue-400 transition-colors"
          ...
          {step === 2 && (
            <div className="animate-in fade-in slide-in-from-right-8 duration-500">
              <button
                onClick={() => setStep(1)}
                className="mb-6 flex items-center text-sm font-bold text-slate-400 hover:text-blue-600 transition-colors"
              >
              ...
              <div className="bg-white p-8 md:p-10 rounded-3xl shadow-xl border border-slate-100">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="col-span-2 md:col-span-1 group">
                    <label className="text-xs font-bold text-slate-400 uppercase tracking-wider mb-2 block group-focus-within:text-blue-600">
                      Full Name
                    </label>
                    <div className="relative">
                      <User
                        className="absolute left-4 top-3.5 text-slate-300 group-focus-within:text-blue-500"
                        size={18}
                      />
                      <input
                        className="w-full pl-12 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-xl outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-500 transition-all font-medium"
                  ...
                  <div className="col-span-2 md:col-span-1">
                    ...
                    <input
                      type="date"
                      className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl outline-none focus:border-blue-500 font-medium"
                      onChange={(e) =>
                ...
                <div className="flex justify-end mt-10">
                  <button
                    onClick={() => setStep(4)}
                    className="bg-blue-600 text-white px-10 py-4 rounded-xl font-bold text-lg hover:bg-blue-700 hover:shadow-lg hover:-translate-y-1 transition-all flex items-center gap-2"
                  >
              ...
              <div className="bg-white rounded-3xl shadow-2xl border border-slate-100 overflow-hidden relative">
                ...
                <div className="p-6 bg-slate-50 border-t border-slate-100">
                  <button
                    ...
                    className="w-full bg-slate-900 text-white py-4 rounded-xl font-bold text-lg hover:bg-black hover:shadow-xl transition-all flex justify-center items-center gap-2"
                  >
          ...
          {step === 5 && (
            <div className="flex flex-col items-center justify-center pt-10 px-4 animate-in zoom-in-95 duration-700 w-full">
              <div className="w-20 h-20 md:w-24 md:h-24 bg-emerald-100 rounded-full flex items-center justify-center mb-6 shadow-emerald-100 shadow-xl">
                <CheckCircle2
              ...
              <h1 className="text-2xl md:text-4xl font-extrabold text-slate-800 mb-2 text-center">
                Booking Confirmed!
              </h1>

              <p className="text-slate-500 text-base md:text-lg mb-8 md:mb-10 max-w-md text-center leading-relaxed">
                Your appointment has been successfully scheduled. A confirmation
                email has been sent.
              </p>

              {/* ID Card */}
              <div className="bg-white border-2 border-slate-100 rounded-3xl p-6 md:p-8 w-full max-w-sm text-center shadow-2xl relative overflow-hidden">
                ...
                <div className="bg-slate-50 rounded-xl py-3 md:py-4 border border-slate-200 border-dashed">
                  <p className="text-2xl md:text-3xl font-mono font-bold text-blue-600 tracking-tighter select-all break-all">
                    {bookingRef}
                  </p>
                </div>
                <p className="text-xs text-slate-400 mt-4">
                  Please present this ID at the laboratory.
                </p>
              </div>

              {/* Buttons Container */}
              <div className="mt-8 md:mt-10 flex flex-col md:flex-row gap-3 md:gap-4 w-full max-w-sm md:max-w-none justify-center">
                <button
                  onClick={() => window.location.reload()}
                  className="w-full md:w-auto px-8 py-3 bg-white border border-slate-200 text-slate-600 font-bold rounded-xl hover:bg-slate-50 hover:text-blue-600 transition-colors shadow-sm order-2 md:order-1"
                >
                  Book Another
                </button>
                <button
                  onClick={() => window.print()}
                  className="w-full md:w-auto px-8 py-3 bg-blue-600 text-white font-bold rounded-xl hover:bg-blue-700 hover:shadow-lg transition-all shadow-blue-200 shadow-lg order-1 md:order-2"
                >
                  Download Receipt
                </button>
              </div>
