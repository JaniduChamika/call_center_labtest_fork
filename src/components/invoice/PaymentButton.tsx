...
interface Props {
  amount: number;
  appointmentId: string;
  // --- FIXED: Added missing props to match the Invoice Page call ---
  patientName: string;
  patientPhone: string;
...
export default function PaymentButton({ 
  ...
  const handlePayment = async () => {
    ...
    try {
      // Prepare payment data using real patient details
      const paymentData = {
        bookingId: appointmentId,
        userId: 'guest', 
        amount: amount,
        ...
        metadata: {
          ...
          // --- FIXED: Passing real data instead of "Patient" placeholder ---
      ...
      toast.success('Redirecting to PayHere...', { id: toastId });
